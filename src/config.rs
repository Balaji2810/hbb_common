...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Dark".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["147.93.153.110"];
pub const RS_PUB_KEY: &str = "4h+JLzCbnYOElSZRRpLpLYaKmc44HnBCzXYvGeCFOBU=";
